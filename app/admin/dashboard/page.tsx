  ...
  return (
    <>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-1">
            {(["today", "week", "month", "all"] as const).map((p) => (
              <button key={p} onClick={() => setPeriod(p)} className={`px-3 py-1.5 text-[10px] rounded-lg font-bold capitalize transition-colors ${period === p ? "bg-[#319F44] text-white" : "bg-gray-100 text-gray-500 hover:bg-gray-200"}`}>
                {p === "all" ? "All Time" : p}
              </button>
            ))}
          </div>
      ...
      <div className="p-6">
        ...
        <div className="bg-gradient-to-r from-[#319F44] to-[#267a34] rounded-2xl p-6 text-white mb-6">
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-6">
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
            <div className="px-5 py-3 bg-[#319F44]/10 border-b border-[#319F44]/20">
              <h3 className="font-bold text-sm text-[#319F44] flex items-center gap-2">
            ...
            <div className="p-5 space-y-3">
              ...
              <div className="border-t border-gray-100 pt-2 flex justify-between">
                ...
                <span className="text-sm font-bold text-[#319F44]">₱{groceryPlatformProfit.toLocaleString()}</span>
              </div>
              <div className="bg-[#319F44]/10 rounded-lg px-3 py-2 flex justify-between">
                <span className="text-xs text-[#267a34] font-medium">Platform Profit</span>
                <span className="text-sm font-bold text-[#267a34]">₱{groceryPlatformProfit.toLocaleString()}</span>
              </div>
            </div>
          </div>
            ...
            <div className="p-5 space-y-3">
              ...
              <div className="border-t border-gray-100 pt-2 space-y-1">
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-bold text-[#319F44]">₱{laundryPartnerCommission.toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-xs text-gray-500">Rider Commission ({riderPercent}%)</span>
                  <span className="text-sm font-bold text-[#319F44]">₱{laundryRiderCommission.toLocaleString()}</span>
                </div>
              </div>
              <div className="bg-[#319F44]/10 rounded-lg px-3 py-2 flex justify-between">
                <span className="text-xs text-[#267a34] font-medium">Platform Profit</span>
                <span className="text-sm font-bold text-[#267a34]">₱{(laundryPartnerCommission + laundryRiderCommission).toLocaleString()}</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="divide-y divide-gray-50">
            <div className="px-5 py-3 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-[#319F44]/10 rounded-lg flex items-center justify-center">
              ...
              <span className="font-bold text-sm text-[#319F44]">+₱{groceryPlatformProfit}</span>
            </div>
            <div className="px-5 py-3 flex items-center justify-between">
              <div className="flex items-center gap-3">
              ...
              <span className="font-bold text-sm text-[#319F44]">+₱{laundryRiderCommission}</span>
            </div>
            <div className="px-5 py-3 flex items-center justify-between">
              <div className="flex items-center gap-3">
              ...
              <span className="font-bold text-sm text-[#319F44]">+₱{laundryPartnerCommission}</span>
            </div>
            <div className="px-5 py-4 flex items-center justify-between bg-[#319F44]/10">
              <span className="font-bold text-sm text-green-800">Total Platform Income</span>
              <span className="font-black text-lg text-[#267a34]">₱{totalPlatformIncome.toLocaleString()}</span>
            </div>
          </div>
        </div>
      </div>
