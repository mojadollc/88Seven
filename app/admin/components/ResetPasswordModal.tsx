        ...
        <div className="p-6 space-y-4">
          {result?.success ? (
            ...
            <>
              ...
              {result?.error && (
                <p className="text-xs text-[#267a34] bg-[#319F44]/10 px-3 py-2 rounded-lg">{result.error}</p>
              )}
              <div className="flex gap-3">
                ...
                <button onClick={handleReset} disabled={loading || password.length < 6} className="flex-1 bg-[#319F44] text-white py-2.5 rounded-lg text-sm font-bold disabled:opacity-40">
