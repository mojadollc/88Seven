...
const PRESETS = [
  ...
  { label: "White + Teal", type: "solid", color: "#009689", colorTo: "#009689", text: "#ffffff", bg: "#FFFFFF", banner: "#009689", bannerText: "#ffffff", footerBg: "#006F68", footerText: "#ffffff", headerBg: "#ffffff", headerText: "#009689" },
