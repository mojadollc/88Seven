...
function FailedContent() {
    ...
    return (
      <main className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="text-center max-w-sm w-full">
          ...
          <a href="/" className="block bg-[#319F44] text-white px-6 py-3 rounded-xl font-bold text-sm">
            Go to Home
          </a>
        </div>
      </main>
  ...
  return (
    <main className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="text-center max-w-sm w-full">
        <div className="w-20 h-20 bg-[#59EBC6]/20 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div className="space-y-3">
          <a href={`/${service}`} className="block bg-[#319F44] text-white px-6 py-3 rounded-xl font-bold text-sm">
            Try Again
          </a>
          <button
